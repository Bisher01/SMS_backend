...
Route::prefix('choise')->group(function () {
    ...
    Route::put('edit/{choise}', [\App\Http\Controllers\Exam\ChoiseController::class, 'update']);
    // Route::get('show/{question}', [\App\Http\Controllers\Exam\ExamController::class, 'show']);
    Route::delete('delete/{choise}', [\App\Http\Controllers\Exam\ChoiseController::class, 'destroy']);
});
